    ...
    return (
        <div className={styles.container}>
            <Head>
                ...
                <meta name="desciption" content="Learn how to build a personal website using Next.js" />
            ...
            <header className={styles.header}>
                {home ? (
                    <>
                        <Image priority src="/images/profile.jpg" className={utilStyles.borderCircles} height={144} width={144} alt={name} />
